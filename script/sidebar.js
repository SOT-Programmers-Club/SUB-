...
function set() {
    ...
    <li id="bottom">Configure Sub+</li>
    <li id="bottom">Import & Export Data</li>
    <li id="bottom">Team Members</li>
    <li id="bottom">Sub+ Notifications</li>
...
function sidebar_home() {
    ...
    <div id="sub-main-1">
        ...
        <div style="margin-left:20px ; ">
            <h3>What can Sub+ do for you?</h3>
            Launch and automate your subscription business with Sub+’s <br> invoicing, payment
    ...
    <div id="sub-main-2">
        <div style="margin-left:20px ; ">
            ...
            <p>Welcome to your test site. This is a space for you to play <br> around and get an idea of how
                Sub+ can work for you.</p>
            <p>Interact with the essential elements of Sub+ and see how <br> they come together to make
...
function get_started() {
    ...
    <p style="margin:auto;width:fit-content">This checklist can help you manage essential settings and start using Sub+.</p>
    </div>
    ...
    <p>Integrate Sub+ with your website 
    </p>
    </div>
    <div id="second"></div>
